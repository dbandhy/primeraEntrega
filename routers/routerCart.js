...
routerCarts.post('/:id/products', (req, res) => cartController.addProduct(req, res)); //CORREGIR
routerCarts.delete('/:id/products/:idProd', (req, res) => cartController.deleteProduct(req, res));  //CORREGIR
